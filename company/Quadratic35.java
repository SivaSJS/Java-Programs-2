...
public class Quadratic35 {
    ...
    public static void main(String[] args) {
        ...
        /* The real number a is called the real part of the complex number a + bi;
         the real number b is called its imaginary part */
        // b^2-4ac

        int d = b * b - 4 * a * c;
        if (d > 0) {
            //If the value of d is positive, both roots are real and different.
            // It means there are two real solutions
            double r1 = (-b + Math.pow(d, 0.5)) / (2.0 * a);
            double r2 = (-b - Math.pow(d, 0.5)) / (2.0 * a);
            System.out.println("The roots are " + r1 + " and " + r2);

        } else if (d == 0) {
            //If the value of d is zero, both roots are real and the same.
